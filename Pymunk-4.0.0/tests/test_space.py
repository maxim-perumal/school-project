...
class UnitTestSpace(unittest.TestCase):
    ...
    def testPointQuery(self):       
        ...
        self.assertTrue(self.s1 not in hits)
        self.assertTrue(self.s2 in hits)
        self.assertTrue(s3 in hits)
    ...
    def testSegmentQueries(self):
        ...
        self.assertTrue(self.s1 not in hit_shapes)
        self.assertTrue(self.s2 in hit_shapes)
        self.assertTrue(s3 in hit_shapes)
